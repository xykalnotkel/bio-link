...
// Fallback in-app kalau terjadi error saat render/hydration.
// Lebih baik ini daripada halaman error polos dari platform.
  ...
  return (
    ...
    >
      <div style={{ maxWidth: 360 }}>
        ...
        <p style={{ fontSize: 14, lineHeight: 1.6, color: "rgba(244,244,246,0.65)", margin: "0 0 20px" }}>
          Halaman belum bisa ditampilkan sempurna. Coba muat ulang — biasanya
          langsung pulih.
        </p>
